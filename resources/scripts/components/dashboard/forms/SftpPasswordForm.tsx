...
import {
    type GeneratedSftpPassword,
    type SftpPasswordStatus,
    ...
    return (
        <div className='relative'>
            ...
            <div className='flex gap-3'>
                <Button variant='default' onClick={doGenerate} disabled={loading} type='button'>
                    {status?.active ? 'Regenerate Password' : 'Generate Password'}
                </Button>
                {status?.active && (
                    <Button variant='secondary' onClick={doRevoke} disabled={loading} type='button'>
                        Revoke
                    </Button>
                )}
            </div>
